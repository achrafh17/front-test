...
export default function France24Preview({ genre, duration, fontSize, theme }) {
  ...
  useEffect(() => {
    fetch(
      `https://www.powersmartscreen.com/get-france24-info?genre=${genre}`
    )
      .then((res) => res.json())
      .then((resJson) => {
        if (resJson?.success) {
