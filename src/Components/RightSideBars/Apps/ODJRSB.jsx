  ...
  return (
    ...
    >
      <Box sx={{ flex: 1 }}>
        ...
        >
          <ODJPreview duration={duration} fontSize={fontSize} theme={theme} />
        </Box>
        <Box
          sx={{
            padding: 3,
