...
export default function RSSRSB() {
  ...
  const [name, setName] = useState("RSS");
  ...
  return (
    ...
    >
      <Box sx={{ flex: 1 }}>
        ...
        >
          <RSSPreview link={link} duration={duration} fontSize={fontSize} theme={theme} />
        </Box>
        <Box
          sx={{
            padding: 3,
        ...
        >
          ...
          <Typography sx={{ fontSize: 13, color: "#797c7c" }}>Lien RSS</Typography>
          <TextField
            variant="standard"
            sx={{ width: "100%", mb: 2 }}
            value={link}
